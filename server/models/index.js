...
db.TeamStatistics.belongsTo(db.Team, { foreignKey: 'teamId', targetKey: 'teamId' });  // Corrected
db.TeamStatistics.belongsTo(db.League, { foreignKey: 'leagueId', targetKey: 'leagueId' });  // Corrected
